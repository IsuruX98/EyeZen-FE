  ...
  return (
    <div className='flex flex-col items-center h-screen p-24 px-48 pt-48'>
        <div className='items-center'>
            <h1 className='text-4xl pb-9 text-center'>Cover your one eye at a time and do the test by going <b>10 feet distance</b> from the Screen. <br /><br />Say <b>'Okay'</b> If you can See. Otherwise say <b>'Not clear'</b> when test started</h1>
